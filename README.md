...
Version 1: This version is using just RxJs operators 

Version 2: This version uses store pattern to avoid multiple request calls to load data
           Instead store pattern saves data locally and updates data on modify functionality
